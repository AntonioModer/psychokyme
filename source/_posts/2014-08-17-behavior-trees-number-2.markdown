title: "Behavior Trees #2"
date: 2014-08-17 03:46
tags:
- ai
---

This tutorial features a full implementation of behavior for an enemy using behavior trees<!-- more -->. The previous part of went over the basics of behavior trees as well as their implementation. So look there first if you somehow got here randomly. The enemy behavior we're going to implement is actually quite simple from a player/viewer standpoint, but it's a nice way to introduce most concepts behind behavior trees.
